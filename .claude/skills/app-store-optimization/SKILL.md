...
|--------|------|-------------|
| mobile-deep-linking | modules/mobile-deep-linking/ | Deep link setup for ASO — universal links, deferred deep links, attribution tracking, App Store Smart Banners |
| mobile-app-update | modules/mobile-app-update/ | App update prompts — forced/optional update flows, version checking, App Store/Play Store redirect |
