...
|--------|------|-------------|
| react-native-theme | modules/react-native-theme/ | React Native theming system — dark/light mode, design tokens, dynamic theme switching, styled-components integration |
| mobile-skeleton-loaders | modules/mobile-skeleton-loaders/ | Content placeholder animations for React Native — shimmer effects, skeleton screens, loading state components |
