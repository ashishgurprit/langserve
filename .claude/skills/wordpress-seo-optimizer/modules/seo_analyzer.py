...
and scoring for WordPress posts.
"""
...
class SEOAnalyzer:
    ...
    def analyze(self, post_data: Dict, target_keyword: Optional[str] = None) -> Dict:
        """
        ...
        # Keyword: 15 points + On-page: 70 points + Technical/Schema: 15 points (future)
        ...
        overall_score = int(
            ...
            (onpage_score / 70 * 85)  # 85% weight (will be 70% when technical is added)
        )
    ...
    def _detect_primary_keyword(self, post_data: Dict) -> str:
        ...
        # For MVP, just return the first 2-3 word phrase
        # In future, this could use ML/AI for better detection
    ...
    def _prioritize_recommendations(
        ...
        if keyword_analysis['density'] < 1.0:
            recommendations.append({
                ...
                'action': f"Increase to 1.5% ({keyword_analysis.get('recommendations', [''])[0] if keyword_analysis.get('recommendations') else ''})",
                'impact': '+5-10 points'
            })
...
if __name__ == "__main__":
    ...
    test_post = {
        ...
        'content': """
            ...
            or adult dog, effective dog training techniques can transform your relationship.</p>
            ...
            <p>Once your dog masters the basics, you can move to advanced dog training
            techniques. These include off-leash training and complex commands.</p>
        """,
        'meta_description': "",
    ...
    # Run analysis
    analysis = analyzer.analyze(test_post)
