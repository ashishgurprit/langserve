...
class OnPageOptimizer:
    ...
    def analyze_onpage(self, post_data: Union[Dict, 'NormalizedContent']) -> Dict:
        """
        ...
        Args:
            post_data: Either:
                ...
                - Dictionary with keys: title, content, meta_description, url_slug, target_keyword

        Returns:
            Analysis results with scores and recommendations
        """
        # Handle both dict and NormalizedContent
        if hasattr(post_data, 'title'):
            # NormalizedContent object
            title = post_data.title
            content = post_data.content
            meta_description = post_data.meta_description
            url_slug = post_data.url_slug
            target_keyword = getattr(post_data, 'target_keyword', '')
        else:
            # Dictionary
