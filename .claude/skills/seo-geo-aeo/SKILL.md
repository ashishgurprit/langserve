...
## Google Algorithm Changes (2025)

Three core updates in 2025: March (Mar 13-27), June (Jun 30-Jul 17), December (Dec 11-29).

| Change | Impact |
|--------|--------|
| **E-E-A-T universalized** | No longer just YMYL — E-E-A-T now applies to ALL competitive searches including e-commerce reviews, SaaS comparisons, how-to guides |
| **Original content rewarded** | December 2025 update specifically targets thin, outdated, or overly optimized pages |
| **AI content scrutiny** | Quality signals matter more than production method — AI content must demonstrate genuine expertise |
| **Trust signals amplified** | Authenticity and trust define 2026 SEO success |

**Action items:**
- Ensure all content demonstrates Experience (first-hand) not just Expertise
- E-E-A-T compliance needed for ALL content, not just health/finance
- Focus on original research and unique insights over aggregated content
- Next core update expected March/April 2026
