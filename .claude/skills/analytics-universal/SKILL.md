...
|--------|------|-------------|
| mobile-analytics | modules/mobile-analytics/ | Mobile analytics tracking for React Native — event tracking, screen views, user properties, funnels via Firebase Analytics or Mixpanel |
